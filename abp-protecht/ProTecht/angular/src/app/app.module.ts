...
import { PEOPLE_PERSON_ROUTE_PROVIDER } from './people/person/providers/person-route.provider';
import { QUOTES_QUOTE_ROUTE_PROVIDER } from './quotes/quote/providers/quote-route.provider';
...
@NgModule({
  ...
  providers: [
    ...
    PEOPLE_PERSON_ROUTE_PROVIDER,
    QUOTES_QUOTE_ROUTE_PROVIDER,
  ],
